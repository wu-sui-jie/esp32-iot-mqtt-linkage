...
// 引脚定义
#define SPI_SCK_0 digitalWrite(18, LOW) // 字库sck与屏复用
#define SPI_SCK_1 digitalWrite(18, HIGH)
#define SPI_SDA_0 digitalWrite(23, LOW) // 字库SDA与屏复用
#define SPI_SDA_1 digitalWrite(23, HIGH)
#define SPI_FSO digitalRead(13) // 字库输出
#define SPI_RST_0 digitalWrite(26, LOW)
#define SPI_RST_1 digitalWrite(26, HIGH)
#define SPI_DC_0 digitalWrite(25, LOW)
#define SPI_DC_1 digitalWrite(25, HIGH)
#define SPI_CS_0 digitalWrite(19, LOW)
#define SPI_CS_1 digitalWrite(19, HIGH)
#define SPI_CS2_0 digitalWrite(5, LOW)
#define SPI_CS2_1 digitalWrite(5, HIGH)
// #define BL_PIN    14                    //背光控制引脚
