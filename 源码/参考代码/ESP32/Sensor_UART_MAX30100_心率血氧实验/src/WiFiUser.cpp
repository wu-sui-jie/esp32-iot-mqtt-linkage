...
String ROOT_HTML_2 = "<input type=\"password\" name=\"password\" placeholder=\"请输入 WiFi 密码\" id=\"auth_pass\"; style=\"border-radius: 10px\">  <input type=\"text\" name=\"groupid\" placeholder=\"请输入设备ID（8位）\" id=\"auth_groupid\"; style=\"border-radius: 10px\"> <input type=\"text\" name=\"mqttip\" placeholder=\"请输入MQTT地址\" id=\"auth_mqttip\"; style=\"border-radius: 10px\"> <input type=\"text\" name=\"sensortype\" placeholder=\"请选择传感器类型\" id=\"auth_sensortype\" list = \"sensor-list\"; style=\"border-radius: 10px\"><datalist id = \"sensor-list\"><option> <option>  01 心率血氧传感器</option><option>  02 其他节点</option></datalist>    <div class=\"login-help\">        <ul class=\"list\">          <li class=\"list__item\">          </li>        </ul>      </div>   <input type=\"submit\" class=\"login login-submit\" value=\"确 定 连 接\" id=\"login\"; disabled; style=\"border-radius: 15px\"  >    </form> <!-- <form name=\'input\' action=\'/English\' method=\'POST\'>    <input type=\"submit\" class=\"login login-submit\" value=\"English\" id=\"login\"; disabled; style=\"border-radius: 15px\"  >    </form> --></body></html>";
/*
 * 处理网站根目录的访问请求
 */
void handleRoot() {
